            ...
            <div className="flex flex-wrap">
                <div className="w-full md:w-1/2 p-4">
                    <section className="mt-12p ">
                        <div className="text-xl">1. <span className="ml-3">Privacy Policy
                    ...
                    <div >
                        <section className="mt-12p ">
                            <div className="text-xl">2. <span className="ml-3">Types of information we may collect about you
                                <div className="my-5 ml-8">
                                    <StrokeLine />
                                </div>
                            </span></div>
                        ...
                        <section className="mt-12p ">
                            ...
                            <p className="text-base  text-justify mt-[-2.5%] ml-[4%]">
                                <ul className="list-disc list-inside">
                                    ...
                                    <li className="font-bold">Information about your use of our websites and mobile apps:</li>
                                    We use cookies to help us understand how you use and interact with our digital platforms. This may include what pages you look at, what elements you click, what you search for on our websites, and from which pages you exit our websites. For further information, please see our cookies policy.

                                    <li className="font-bold">Information about the browser and device you are using:</li>
                                    We also use cookies to collect information about your browser and the device you use to access our websites or mobile apps. This may include your IP address, device unique identifiers, operating system, browser type, and network information. For further information, please see our cookies policy.

                                    <li className="font-bold">Information about your location:</li>
                                    If you have enabled location services on your device, we may collect information about your actual location. You can disable location services at any time by updating your preferences on your device.
                        ...
                        <div >
                            <section className="mt-12p ">
                                <div className="text-xl">3. <span className="ml-3">How we look after your information
                                    <div className="my-5 ml-8">
                                        <StrokeLine />
                                    </div>
                                </span></div>
                        ...
                        <div >
                            <section className="mt-12p ">
                                <div className="text-xl">4. <span className="ml-3">How and why we use your information
                                    <div className="my-5 ml-8">
                                        <StrokeLine />
                                    </div>
                                </span></div>
