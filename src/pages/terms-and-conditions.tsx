    ...
    <div className="p-5 md:p-8 lg:p-[75px] ">
      <section>
        <div className="text-center">
          <h1 className="text-2xl font-light leading-normal">
            SCHEDULE 1
          </h1>
      ...
      <div className="flex flex-wrap">
        <div className="w-full md:w-1/2 p-4">
          <section className="mt-12p ">
            <div className="text-xl">1. <span className="ml-3">DEFINITIONS AND INTERPRETATION
            ...
            <p className="text-base ml-[4%] text-justify">
              The words and expressions set out below shall, unless the context requires otherwise, have the following meanings:<br />

              <span className="font-bold">Customer Charter </span> means the Publisher customer charter set out in the appendix to these Member Offer T&Cs;<br />

              <span className="font-bold">Confidential Information </span>means all information relating to a Party’s customers and prospective customers (including without limitation the Personal Data), current or projected financial or trading situations, the terms of this Agreement, business plans, business strategies, developments, and all other information relating to its business affairs, including all other information of a confidential nature (whether or not it is marked “confidential”) imparted by one Party to another Party during the term of this Agreement or coming into existence as a result of either Party's obligations;<br />

              <span className="font-bold">Offer Materials </span> means the advertising, promotional and/or other content to be created by the Publisher in association with the Offer;<br />

              <span className="font-bold">Net Revenue </span> means all sales in relation to the Offer, less VAT and any other costs agreed in writing in advance between the Parties;<br />

              <span className="font-bold">Regulations </span> means The Package Travel and Linked Travel Arrangements Regulations 2018 and the EU Directive on Package Travel and Linked Travel Arrangements (2015/2302/EU);<br />

              <span className="font-bold">SOW </span> means the Statement of Work entered into between the Parties, detailing the Offer, which shall include these terms;<br />

              <span className="font-bold">Supplier Materials </span> means the materials supplied to the Publisher for inclusion in the Offer Materials, including but not limited to the Supplier name, any copy, branding, logos, and trademarks; and<br />

              <span className="font-bold">Working Day </span> means any day other than a Saturday, Sunday or public holiday on which banks in London are open for business.
            </p>
          </section>
          ...
          <section className="mt-12p ">
            ...
            <p className="text-base  text-justify mt-[-2.5%] ml-[4%]" >
              ...
              a) words importing the singular shall include the plural and vice versa;<br />
              b) words importing any particular gender shall include all other genders;<br />
              c) references to persons shall include bodies of persons whether corporate or incorporate;<br />
              d) words importing the whole shall be treated as including a reference to any part of the whole; and<br />
              e) any capitalised terms used herein shall have the definition given to them in these Member Offer T&Cs, the Data T&Cs, or the SOW.
            </p>
          </section>
          <section className="mt-12p ">
            <div className="text-x">1.2 </div>
            <p className="text-base  text-justify mt-[-2.5%] ml-[4%]">
              Any reference to any statute or statutory provision shall be construed
              as referring to that statute or statutory provision as amended,
              modified, extended, re-enacted or replaced from time to time.
          ...
          <section className="mt-12p ">
            ...
            <p className="text-base  text-justify mt-[-2.5%] ml-[4%]">
              ...
              other similar phrases shall be construed as illustrative only and will
              not be taken to limit the meaning of the preceding words.
            </p>
          </section>

          <div >
            <section className="mt-12p ">
              <div className="text-xl">2. <span className="ml-3">MEMBER OFFER
                <div className="my-5 ml-8">
                  <StrokeLine />
                </div>
              </span></div>
            ...
            <section className="mt-12p ">
              ...
              <p className="text-base  text-justify mt-[-2.5%] ml-[4%]" >
                Subject to the Supplier providing the Publisher with the Supplier
                Materials in accordance with any given specifications and deadlines,
                the Publisher shall use reasonable endeavours to promote the Offer
                in the Membership Scheme in accordance with the SOW
              </p>
            </section>
            <section className="mt-12p ">
              <div className="text-x">2.2 </div>
              <p className="text-base  text-justify mt-[-2.5%] ml-[4%]">
                The Parties agree that the Supplier will be the sole organiser of the
                Offer in accordance with the SOW.
            ...
            <section className="mt-12p ">
              ...
              <p className="text-base  text-justify mt-[-2.5%] ml-[4%]">
                ...
                during the Term to use the Supplier Materials in connection with the
                Offer.
              </p>
            </section>
            <section className="mt-12p ">
              ...
              <p className="text-base  text-justify mt-[-2.5%] ml-[4%]">
                The Publisher shall have sole editorial control of all Offer Materials.
              </p>
            </section>

            <div >
              <section className="mt-12p ">
                <div className="text-xl">3. <span className="ml-3">CHANGES TO AGREED DETAILS OF OFFER
                  <div className="my-5 ml-8">
                    <StrokeLine />
                  </div>
                </span></div>
                ...
                <p className="text-base  mt-[1%] text-justify  ml-[4%]" >
                  The Supplier shall use its best endeavours to ensure that the Offer is
                  provided as detailed in the SOW. In the event of any actual or
                  anticipated change to the Offer, the Supplier shall immediately advise
                  the Publisher’s Representative of such change.
                </p>
              </section>
            ...
            <div >
              <section className="mt-12p ">
                <div className="text-xl">4. <span className="ml-3">INSURANCE
                  <div className="my-5 ml-8">
                    <StrokeLine />
                  </div>
                </span></div>
                ...
                <p className="text-base  mt-[1%] text-justify  ml-[4%]" >
                  The Supplier shall maintain in force insurance against and in respect
                  of all risks arising in relation to the Offer for which it could in any way
                  be held responsible and shall prompt provide a copy of associated
                  policy documents to the Publisher on demand.
                </p>
              </section>
              <section className="mt-12p ">
                <div className="text-xl">5. <span className="ml-3">FEES AND PAYMENT
                  <div className="my-5 ml-8">
                    <StrokeLine />
                  </div>
